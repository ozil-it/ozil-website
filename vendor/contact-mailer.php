...
if($_POST)
{
    ...
    $your_email = "grider147@gmail.com";
   ...
   $mail->Username   = 'grider147@gmail.com';                     // SMTP username
   $mail->Password   = '9978880881';                         // SMTP password
   $mail->SMTPSecure = 'TLS';         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
   $mail->Port       = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom($user_Email,$user_Name);
    $mail->addAddress($your_email, 'Test');     // Add a recipient
    ...
    if(!$mail->send())
    {
        ...
        $output = json_encode(array('type'=>'message', 'text' => 'Hi '.$user_Name .' Thank you for contacting us will get back to you soon.'));
        die($output);
    }
}
?>